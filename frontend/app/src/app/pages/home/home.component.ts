...
export class HomeComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private notification: NzNotificationService,
              @Inject(AUTOMATIONS_SERVICE_TOKEN) private automationsService: IAutomationsService, private router: Router) {
  }
  ...
  ngOnInit() {
    this.automationForm = this.fb.group({
      ...
      automationPosition: ['', {validators: [Validators.required, Validators.min(1)]}],
